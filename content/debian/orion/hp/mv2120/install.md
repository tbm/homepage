...
"http://ftp.nl.debian.org/debian/dists/stable/main/installer-armel/current/images/orion5x/network-console/hp/mv2120/netboot.img">Debian
...
<img src = "../images/di-remove-logical-volume-data.png" class="border"
