...
href="http://archive.debian.org/debian/dists/buster/main/installer-armel/current/images/kirkwood/network-console/qnap/ts-11x/flash-debian">script is run</a> to ensure that the same MAC
